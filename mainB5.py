...
from treinoTeste import testar, treinar, TestarGrupos_F1_Macro, ColetarMetricas_Detalhadas
...
pasta_graficos_main = "Log_de_analise"
os.makedirs(pasta_graficos_main, exist_ok=True)

for args.comDefesa in [False]:
    ...
    for wm in [4, 10]: 
        ...
        for epoca in range(args.epoca):
            ...
            metricas = ColetarMetricas_Detalhadas(modelosAgregados, testSetClientes, device)
